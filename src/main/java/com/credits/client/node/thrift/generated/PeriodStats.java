...
public class PeriodStats implements org.apache.thrift.TBase<PeriodStats, PeriodStats._Fields>, java.io.Serializable, Cloneable, Comparable<PeriodStats> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.balancePerCurrency = new java.util.HashMap<java.lang.Byte,CumulativeAmount>(2*_map24.size);
                byte _key25;
                @org.apache.thrift.annotation.Nullable CumulativeAmount _val26;
                for (int _i27 = 0; _i27 < _map24.size; ++_i27)
                {
                  _key25 = iprot.readByte();
                  _val26 = new CumulativeAmount();
                  _val26.read(iprot);
                  struct.balancePerCurrency.put(_key25, _val26);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PeriodStats struct) throws org.apache.thrift.TException {
      ...
      if (struct.balancePerCurrency != null) {
        oprot.writeFieldBegin(BALANCE_PER_CURRENCY_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.Byte, CumulativeAmount> _iter28 : struct.balancePerCurrency.entrySet())
          {
  ...
  private static class PeriodStatsTupleScheme extends org.apache.thrift.scheme.TupleScheme<PeriodStats> {
      ...
      if (struct.isSetBalancePerCurrency()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Byte, CumulativeAmount> _iter29 : struct.balancePerCurrency.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, PeriodStats struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TMap _map30 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.BYTE, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.balancePerCurrency = new java.util.HashMap<java.lang.Byte,CumulativeAmount>(2*_map30.size);
          byte _key31;
          @org.apache.thrift.annotation.Nullable CumulativeAmount _val32;
          for (int _i33 = 0; _i33 < _map30.size; ++_i33)
          {
            _key31 = iprot.readByte();
            _val32 = new CumulativeAmount();
            _val32.read(iprot);
            struct.balancePerCurrency.put(_key31, _val32);
          }
        }
        struct.setBalancePerCurrencyIsSet(true);
      }
