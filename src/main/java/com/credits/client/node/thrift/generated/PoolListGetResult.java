            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pools = new java.util.ArrayList<Pool>(_list42.size);
                @org.apache.thrift.annotation.Nullable Pool _elem43;
                for (int _i44 = 0; _i44 < _list42.size; ++_i44)
                {
                  _elem43 = new Pool();
                  _elem43.read(iprot);
                  struct.pools.add(_elem43);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.pools = new java.util.ArrayList<Pool>(_list47.size);
          @org.apache.thrift.annotation.Nullable Pool _elem48;
          for (int _i49 = 0; _i49 < _list47.size; ++_i49)
          {
            _elem48 = new Pool();
            _elem48.read(iprot);
            struct.pools.add(_elem48);
          }
        }
        struct.setPoolsIsSet(true);
      }
