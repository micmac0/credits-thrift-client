            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.arguments = new java.util.ArrayList<SmartContractMethodArgument>(_list108.size);
                @org.apache.thrift.annotation.Nullable SmartContractMethodArgument _elem109;
                for (int _i110 = 0; _i110 < _list108.size; ++_i110)
                {
                  _elem109 = new SmartContractMethodArgument();
                  _elem109.read(iprot);
                  struct.arguments.add(_elem109);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SmartContractMethod struct) throws org.apache.thrift.TException {
      ...
      if (struct.arguments != null) {
        oprot.writeFieldBegin(ARGUMENTS_FIELD_DESC);
        {
          ...
          for (SmartContractMethodArgument _iter111 : struct.arguments)
          {
      ...
      if (struct.isSetArguments()) {
        {
          ...
          for (SmartContractMethodArgument _iter112 : struct.arguments)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.arguments = new java.util.ArrayList<SmartContractMethodArgument>(_list113.size);
          @org.apache.thrift.annotation.Nullable SmartContractMethodArgument _elem114;
          for (int _i115 = 0; _i115 < _list113.size; ++_i115)
          {
            _elem114 = new SmartContractMethodArgument();
            _elem114.read(iprot);
            struct.arguments.add(_elem114);
          }
        }
        struct.setArgumentsIsSet(true);
      }
