            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.smartContractsList = new java.util.ArrayList<SmartContract>(_list74.size);
                @org.apache.thrift.annotation.Nullable SmartContract _elem75;
                for (int _i76 = 0; _i76 < _list74.size; ++_i76)
                {
                  _elem75 = new SmartContract();
                  _elem75.read(iprot);
                  struct.smartContractsList.add(_elem75);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SmartContractsListGetResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.smartContractsList != null) {
        oprot.writeFieldBegin(SMART_CONTRACTS_LIST_FIELD_DESC);
        {
          ...
          for (SmartContract _iter77 : struct.smartContractsList)
          {
            _iter77.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetSmartContractsList()) {
        {
          ...
          for (SmartContract _iter78 : struct.smartContractsList)
          {
            _iter78.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.smartContractsList = new java.util.ArrayList<SmartContract>(_list79.size);
          @org.apache.thrift.annotation.Nullable SmartContract _elem80;
          for (int _i81 = 0; _i81 < _list79.size; ++_i81)
          {
            _elem80 = new SmartContract();
            _elem80.read(iprot);
            struct.smartContractsList.add(_elem80);
          }
        }
        struct.setSmartContractsListIsSet(true);
      }
