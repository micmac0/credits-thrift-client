            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.balances = new java.util.ArrayList<TokenBalance>(_list150.size);
                @org.apache.thrift.annotation.Nullable TokenBalance _elem151;
                for (int _i152 = 0; _i152 < _list150.size; ++_i152)
                {
                  _elem151 = new TokenBalance();
                  _elem151.read(iprot);
                  struct.balances.add(_elem151);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TokenBalancesResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.balances != null) {
        oprot.writeFieldBegin(BALANCES_FIELD_DESC);
        {
          ...
          for (TokenBalance _iter153 : struct.balances)
          {
      ...
      if (struct.isSetBalances()) {
        {
          ...
          for (TokenBalance _iter154 : struct.balances)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.balances = new java.util.ArrayList<TokenBalance>(_list155.size);
          @org.apache.thrift.annotation.Nullable TokenBalance _elem156;
          for (int _i157 = 0; _i157 < _list155.size; ++_i157)
          {
            _elem156 = new TokenBalance();
            _elem156.read(iprot);
            struct.balances.add(_elem156);
          }
        }
        struct.setBalancesIsSet(true);
      }
