            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.transfers = new java.util.ArrayList<TokenTransfer>(_list158.size);
                @org.apache.thrift.annotation.Nullable TokenTransfer _elem159;
                for (int _i160 = 0; _i160 < _list158.size; ++_i160)
                {
                  _elem159 = new TokenTransfer();
                  _elem159.read(iprot);
                  struct.transfers.add(_elem159);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TokenTransfersResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.transfers != null) {
        oprot.writeFieldBegin(TRANSFERS_FIELD_DESC);
        {
          ...
          for (TokenTransfer _iter161 : struct.transfers)
          {
      ...
      if (struct.isSetTransfers()) {
        {
          ...
          for (TokenTransfer _iter162 : struct.transfers)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.transfers = new java.util.ArrayList<TokenTransfer>(_list163.size);
          @org.apache.thrift.annotation.Nullable TokenTransfer _elem164;
          for (int _i165 = 0; _i165 < _list163.size; ++_i165)
          {
            _elem164 = new TokenTransfer();
            _elem164.read(iprot);
            struct.transfers.add(_elem164);
          }
        }
        struct.setTransfersIsSet(true);
      }
