...
public class TransactionsStateGetResult implements org.apache.thrift.TBase<TransactionsStateGetResult, TransactionsStateGetResult._Fields>, java.io.Serializable, Cloneable, Comparable<TransactionsStateGetResult> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.states = new java.util.HashMap<java.lang.Long,TransactionState>(2*_map82.size);
                long _key83;
                @org.apache.thrift.annotation.Nullable TransactionState _val84;
                for (int _i85 = 0; _i85 < _map82.size; ++_i85)
                {
                  _key83 = iprot.readI64();
                  _val84 = com.credits.client.node.thrift.generated.TransactionState.findByValue(iprot.readI32());
                  struct.states.put(_key83, _val84);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TransactionsStateGetResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.states != null) {
        oprot.writeFieldBegin(STATES_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.Long, TransactionState> _iter86 : struct.states.entrySet())
          {
            oprot.writeI64(_iter86.getKey());
            oprot.writeI32(_iter86.getValue().getValue());
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TransactionsStateGetResultTupleScheme extends org.apache.thrift.scheme.TupleScheme<TransactionsStateGetResult> {
      ...
      if (struct.isSetStates()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Long, TransactionState> _iter87 : struct.states.entrySet())
          {
            oprot.writeI64(_iter87.getKey());
            oprot.writeI32(_iter87.getValue().getValue());
          }
        }
      }
      if (struct.isSetRoundNum()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TransactionsStateGetResult struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map88 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.states = new java.util.HashMap<java.lang.Long,TransactionState>(2*_map88.size);
          long _key89;
          @org.apache.thrift.annotation.Nullable TransactionState _val90;
          for (int _i91 = 0; _i91 < _map88.size; ++_i91)
          {
            _key89 = iprot.readI64();
            _val90 = com.credits.client.node.thrift.generated.TransactionState.findByValue(iprot.readI32());
            struct.states.put(_key89, _val90);
          }
        }
        struct.setStatesIsSet(true);
      }
