            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.wallets = new java.util.ArrayList<WalletInfo>(_list190.size);
                @org.apache.thrift.annotation.Nullable WalletInfo _elem191;
                for (int _i192 = 0; _i192 < _list190.size; ++_i192)
                {
                  _elem191 = new WalletInfo();
                  _elem191.read(iprot);
                  struct.wallets.add(_elem191);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WalletsGetResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.wallets != null) {
        oprot.writeFieldBegin(WALLETS_FIELD_DESC);
        {
          ...
          for (WalletInfo _iter193 : struct.wallets)
          {
      ...
      if (struct.isSetWallets()) {
        {
          ...
          for (WalletInfo _iter194 : struct.wallets)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.wallets = new java.util.ArrayList<WalletInfo>(_list195.size);
          @org.apache.thrift.annotation.Nullable WalletInfo _elem196;
          for (int _i197 = 0; _i197 < _list195.size; ++_i197)
          {
            _elem196 = new WalletInfo();
            _elem196.read(iprot);
            struct.wallets.add(_elem196);
          }
        }
        struct.setWalletsIsSet(true);
      }
