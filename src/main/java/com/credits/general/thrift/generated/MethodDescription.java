            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.arguments = new java.util.ArrayList<MethodArgument>(_list34.size);
                @org.apache.thrift.annotation.Nullable MethodArgument _elem35;
                for (int _i36 = 0; _i36 < _list34.size; ++_i36)
                {
                  _elem35 = new MethodArgument();
                  _elem35.read(iprot);
                  struct.arguments.add(_elem35);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MethodDescription struct) throws org.apache.thrift.TException {
      ...
      if (struct.arguments != null) {
        oprot.writeFieldBegin(ARGUMENTS_FIELD_DESC);
        {
          ...
          for (MethodArgument _iter37 : struct.arguments)
          {
            _iter37.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetArguments()) {
        {
          ...
          for (MethodArgument _iter38 : struct.arguments)
          {
            _iter38.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.arguments = new java.util.ArrayList<MethodArgument>(_list39.size);
          @org.apache.thrift.annotation.Nullable MethodArgument _elem40;
          for (int _i41 = 0; _i41 < _list39.size; ++_i41)
          {
            _elem40 = new MethodArgument();
            _elem40.read(iprot);
            struct.arguments.add(_elem40);
          }
        }
        struct.setArgumentsIsSet(true);
      }
